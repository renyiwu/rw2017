...
df <- fread("data/RNA_MES13/mes13_featurecounts_Dec2017_david.csv")


colnames(df)
df1 <- df[, c("Geneid", "Length", "WJ1.dedup.bam", "WJ2.dedup.bam", "WJ3.dedup.bam")]

colnames(df1) <- c("Geneid", "Length", "LG", "HG", "HG+MITC")
 
df11 <- data.frame(df1[,-(1:2)])
rownames(df11) <- df1$Geneid
